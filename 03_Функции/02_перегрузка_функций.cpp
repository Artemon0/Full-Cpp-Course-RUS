...
void print(int value) {
    cout << "Целое number: " << value << endl;
}

void print(double value) {
    cout << "Дробное number: " << value << endl;
}
...
int convert(string row) {
    return stoi(row);
}

double convert(string row, bool вДробное) {
    return stod(row);
}
 ...
 * 
 * ЗАДАНИЕ:
 * 1. Создайте перегруженную функцию для вычисления объема (куб, параллелепипед, цилиндр)
 * 2. Напишите перегруженную функцию для сравнения (два numbers, три numbers, массивы)
