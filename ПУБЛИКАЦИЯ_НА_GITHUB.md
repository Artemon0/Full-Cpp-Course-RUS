...
📖 **Подробная инструкция:** см. `КАК_СОЗДАТЬ_RELEASE.md`

**Быстрый способ:**
1. Откройте https://github.com/Artemon0/Full-Cpp-Course-RUS/releases/new
2. Tag: `v1.0.0`
3. Title: `🎉 Полный курс C++ v1.0.0 - Первый релиз!`
4. Description: Скопируйте из `RELEASE_v1.0.0.md`
5. ✅ Set as the latest release
6. Publish release

✅ **Готово!** Пользователи смогут скачать курс одним архивом.
